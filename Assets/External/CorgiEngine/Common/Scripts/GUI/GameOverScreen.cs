...
{
    public class GameOverScreen : CorgiMonoBehaviour
    {
        /// the level to load after the start screen
        [Tooltip("the level to load after the start screen"), MMSceneName]
        public string StartScreen = "StartScreen";
        /// the name of the loading screen to use to load NextLevel
        [Tooltip("the name of the loading screen to use to load NextLevel"), MMSceneName]
